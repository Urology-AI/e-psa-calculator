...
//              MODEL_ACCURACY.model3 below describes an earlier N=83 GG3+
//              iteration of this model, superseded by calcHighGradeRisk.
//
...
export const MODEL_ACCURACY = {
  ...
  model3: {
    ...
    note: 'Logistic regression trained on N=83 patients with PI-RADS + biopsy outcome. ' +
          ...
          'Superseded by the current N=96 GG≥2 model (see calcHighGradeRisk).'
  },
  model4: {
